...
![Экран сотрудника: готовность к цели, навыки, рекомендованные шаги с факторами](docs/screen_employee.png)

![Экран HR: готовность команды, что требует внимания, отстающие навыки](docs/screen_hr.png)
