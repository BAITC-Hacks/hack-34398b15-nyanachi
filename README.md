...
Ссылки в один клик (логин уже в ссылке; если браузер всё же спросит — `judge` / `drynsDhqCPsV`):
- Сотрудник `E0002`, интерфейс на русском: https://judge:drynsDhqCPsV@kitan-a.com/careerquest/?employee=E0002&lang=ru
- Сотрудник `E0001` (сценарий из раздела проверки): https://judge:drynsDhqCPsV@kitan-a.com/careerquest/?employee=E0001
- Экран HR сразу с входом: https://judge:drynsDhqCPsV@kitan-a.com/careerquest/?view=hr&hr=hr-demo&lang=ru

Те же параметры работают и локально, например http://127.0.0.1:8000/?view=hr&hr=hr-demo. После открытия они убираются из адресной строки.
